...
This mod has only been tested by myself on **Microsoft Store / Game Pass**.  
...
**Q: Does this work on Steam?**  
A: Unknown — only tested on Microsoft Store / Game Pass. If you try it on Steam, please report in the comments!
...
Available on [GitHub](https://github.com/zeusfail/NoRestrictionsConstruction) — if you enjoy the mod :3
